...
get_rbs_electricity_consumption_data <- function(rbs_electricity_consumption_data_file, rbs_outputs_data_file) {
  # read in data
  ...
  # rbs_connections_data <- read_excel(rbs_outputs_data_file, sheet = "HH-State")
