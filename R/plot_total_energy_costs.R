...
plot_total_energy_costs <- function(average_net_costs,
  ...
  #Constructing total household energy costs by state and scenario over time 
  
  total_energy_chart <- average_net_costs %>% 
    filter(state != "WA",
  ...
  grattan_save_all("/Users/bjjefferson/Grattan Institute Dropbox/Ben Jefferson/Apps/Overleaf/energy-2025-carbon-pricing-for-electricity/atlas/Energy Bills/total_energy_costs.pdf",
                   object = total_energy_chart)

  return(total_energy_chart)
}
