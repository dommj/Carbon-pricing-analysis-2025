...
### Waterfall chart ####
#### This is a slightly modified version of Hugh Parsonage's waterfall chart package.
## I added two extra parameters to control features of interest:
## rect_text_colour and linecolour
## both are passed straight to the relevant arguments in annotate()
...
#' @param rect_text_colour colour of the text in the rectangles
...
#' @param linecolour the colour for the draw_lines
