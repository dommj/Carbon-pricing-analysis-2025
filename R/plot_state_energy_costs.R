...
plot_state_energy_costs <- function(average_net_costs,
  ...
  state_energy_costs_plot <- average_net_costs %>% 
  ...
  grattan_save_all("/Users/bjjefferson/Grattan Institute Dropbox/Ben Jefferson/Apps/Overleaf/energy-2025-carbon-pricing-for-electricity/atlas/Energy Bills/state_energy_costs.pdf",
                   object = state_energy_costs_plot)

  return(state_energy_costs_plot)
}
