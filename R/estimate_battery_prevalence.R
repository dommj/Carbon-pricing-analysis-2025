...
estimate_battery_prevalence <- function(esoo_2024_assumptions_workbook_file,
  ...
  ## In the name here, you say you are pulling in degraded MWH capacity, but you actually pull in MW
  ## degraded MWH is further down the sheet
  ## But given you use it to calc a number of batteries based on the advertised capacity of 11kw, it's probably the correct data?
