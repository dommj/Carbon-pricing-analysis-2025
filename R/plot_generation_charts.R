...
plot_generation_charts <- function(results_ref,
  ...
  scenarios <- data.frame(
    ...
    file_name = c('reference_generation_plot.pdf', '2_degree_ret_generation_plot.pdf', 
                  '2_degree_safeguard_generation_plot.pdf', '1_5_degree_ret_generation_plot.pdf',
                  '1_5_degree_safeguard_generation_plot.pdf'),
    stringsAsFactors = FALSE
  )
