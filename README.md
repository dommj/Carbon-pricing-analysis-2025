...
This project provides the underlying household budget analysis for the 2025 Grattan Institute report  
[*Bills down, emissions down: A practical path to net-zero electricity*](https://grattan.edu.au/report/bills-down-emissions-down-a-practical-path-to-net-zero-electricity/).
